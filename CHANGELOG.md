...
- Corrected the 00:36-00:43 pacing in the active v03 treatment after AKLO's note: the daylight/window transition now completes before 00:39, and the 00:39 "hit the lights" block starts already in the dark-room setup with the bulb flicking on and cockroaches scattering on the lyric. Saved pre/post local snapshots and synced the corrected version back to the active v03 Google Doc.
- Added AKLO's 00:49-00:53 Polaroid freeze-frame note to the active v03 treatment: the serving/law transaction now ends with a Polaroid-style snap that foreshadows the later developed-photo/feds dark-room idea. Saved pre/post local snapshots and synced the update back to the active v03 Google Doc.
