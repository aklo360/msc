# Dark Room Music Video Treatment

## Overview

Subproject under the main MSC / Mr Star City workspace for the "Dark Room" music-video treatment.
...
Create a reviewable music-video treatment package for "Dark Room" that AKLO can iterate on from phone, gym, laptop, or Mini without losing continuity.

## Deliverables

- Treatment draft in `TREATMENT.md`
...
- v1.0 story-audit-clean Google Doc copy, with J train / film-development story shots removed and only Polaroid/VFX language retained: https://docs.google.com/document/d/1G2UZsqHkrRhiehz_MhQRapcYjVjaoTV5JNz3L5Tbui4/edit?usp=drivesdk
...
- Manual savepoint Google Doc copy, captured after AKLO's 2026-07-01 18:29 ET restore: https://docs.google.com/document/d/1nubkVBPIoLYGc79gE4_HriPiNCoNCJFfngKoxubcltU/edit?usp=drivesdk
- Camera/edit notes Google Doc: https://docs.google.com/document/d/1lT8j0EMMKo3ZjaGBgSEQfuX8BPdiZJXN3Nfs7UZbzV4/edit?usp=drivesdk
- Supporting references in `refs/`
- Source/input assets in `assets/`
- Final exports or PDFs in `exports/`

## Current Priority

Preserve the locked v1.0 master as the approved baseline. Future workshop edits should start from the active v03 Google Doc and become a new revision only when AKLO explicitly promotes them.

## Next Actions

- [ ] Verify exact song structure and timestamps against `assets/Darkroom_master v1_1644_MBDW042325.m4a`.
...
- [ ] Add visual references for rooftop luxury, trap-house texture, club lighting, Polaroid/evidence VFX, and transformation VFX.
- [ ] Export only after AKLO approves the treatment direction.

## Open Questions

- Is this treatment for client/internal approval, production planning, or both?
- What is the intended deadline?
- Are there must-use locations, props, performers, or archive materials?
- Should the trap-house memory feel literal, supernatural, psychological, or music-video symbolic?
- Should the hook/title phrase be treated visually as "dark room," "dog room," or a deliberate double-reading?

## Notes

- Keep this subproject inside the existing MSC room instead of creating a separate Mini project room.
- The Google Doc is an active live editing surface. Before any future write/replace sync, export or read the live doc first and reconcile AKLO's direct edits; never blindly replace it from the local markdown copy.
- The current locked master is the 2026-07-01 18:32 ET Google Doc update and its latest-master copy. Treat that version as the baseline before making further adjustments; the 18:29 ET savepoint remains a fallback.
...
- The v1.0 story-audit-clean copy removes the J train / Williamsburg Bridge B-story and film-development storyline. Keep Polaroid freezes, evidence-wall/dark-room VFX, and lyric-driven photo references only; do not reintroduce a literal train, bridge, photo lab, or film-development story unless AKLO explicitly asks.
